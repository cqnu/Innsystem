...
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2017/3/10 14:56:10   N/A    初版
*
...
namespace HN863Soft.ISS.DAL
{
    ...
    public partial class SoftConsultingS
    {
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("Id", "SoftConsultingS");
        }
        ...
        public bool Exists(int Id)
        {
            ...
            strSql.Append("select count(1) from SoftConsultingS");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(HN863Soft.ISS.Model.SoftConsultingS model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into SoftConsultingS(");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(HN863Soft.ISS.Model.SoftConsultingS model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update SoftConsultingS set ");
            ...
            parameters[11].Value = model.IsVis;
        ...
        public bool Delete(int Id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from SoftConsultingS ");
            strSql.Append(" where Id=@Id");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public HN863Soft.ISS.Model.SoftConsultingS GetModel(int Id)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 Id,SName,SIntroduction,TeamIntroduction,Example,Phone,Type,IsVis,CreateDate,LogImg,KeyWord,Introduce,CreatorId from SoftConsultingS ");
            strSql.Append(" where Id=@Id");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
            ...
            HN863Soft.ISS.Model.SoftConsultingS model = new HN863Soft.ISS.Model.SoftConsultingS();
        ...
        /// 得到一个对象实体
        /// </summary>
        public HN863Soft.ISS.Model.SoftConsultingS DataRowToModel(DataRow row)
        {
            HN863Soft.ISS.Model.SoftConsultingS model = new HN863Soft.ISS.Model.SoftConsultingS();
            if (row != null)
            {
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM SoftConsultingS ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from SoftConsultingS T ");
        ...
        /// 更新一条数据:审核
        /// </summary>
        public bool UpdateIsVis(HN863Soft.ISS.Model.SoftConsultingS model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update SoftConsultingS set ");
            strSql.Append(" IsVis=@IsVis, ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            //strSql.Append("SELECT Id,SName,SIntroduction,TeamIntroduction,Example,Phone,Type,IsVis,CreateDate,LogImg,KeyWord,Introduce,CreatorId,  ROW_NUMBER() OVER (order by Id desc) rowIndex ");
            //strSql.Append(" FROM SoftConsultingS ");
            strSql.Append(" select ROW_NUMBER() OVER (ORDER BY a.id desc) AS rowIndex, a.*,u.UserName from SoftConsultingS a ");
