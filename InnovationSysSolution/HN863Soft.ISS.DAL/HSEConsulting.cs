...
namespace HN863Soft.ISS.DAL
{
    ...
    public partial class HSEConsulting
    {
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("Id", "HSEConsulting");
        }
        ...
        public bool Exists(int Id)
        {
            ...
            strSql.Append("select count(1) from HSEConsulting");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into HSEConsulting(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update HSEConsulting set ");
        ...
        public bool Delete(int Id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from HSEConsulting ");
            strSql.Append(" where Id=@Id");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
        ...
        public HN863Soft.ISS.Model.HSEConsulting GetModel(int Id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 Id,SName,SIntroduction,TeamIntroduction,Example,Phone,Type,IsVis,CreateDate,LogImg,KeyWord,Introduce,CreatorId from HSEConsulting");
            strSql.Append(" where Id=@Id");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
            ...
            HN863Soft.ISS.Model.HSEConsulting model = new HN863Soft.ISS.Model.HSEConsulting();
        ...
        /// 得到一个对象实体
        /// </summary>
        public HN863Soft.ISS.Model.HSEConsulting DataRowToModel(DataRow row)
        {
            HN863Soft.ISS.Model.HSEConsulting model = new HN863Soft.ISS.Model.HSEConsulting();
            if (row != null)
            {
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM HSEConsulting ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from HSEConsulting T ");
        ...
        public DataSet GetList(int pageSize, int pageIndex, string strWhere, string filedOrder, out int recordCount)
        {
            ...
            strSql.Append(" select ROW_NUMBER() OVER (ORDER BY a.id desc) AS rowIndex, a.*,u.UserName from HSEConsulting a ");
