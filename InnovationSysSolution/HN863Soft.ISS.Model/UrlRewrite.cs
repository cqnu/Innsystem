...
namespace HN863Soft.ISS.Model
{
    ...
    public partial class UrlRewrite
    {
        ...
        private List<UrlRewriteItem> _urlRewriteItems;
        ...
        /// URL字典重写表达式
        /// </summary>
        public List<UrlRewriteItem> UrlRewriteItems
        {
            set { _urlRewriteItems = value; }
            get { return _urlRewriteItems; }
        }
    ...
    /// </summary>
    [Serializable]
    public partial class UrlRewriteItem
    {
        //无参构造函数
        public UrlRewriteItem() { }
