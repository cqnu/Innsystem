...
namespace HN863Soft.ISS.Common
{
    ...
    {
        public static Encoding DefaultEncoding = Encoding.GetEncoding("UTF-8"); //文本格式UTF-8
        ...
        /// <summary>
        /// 获取文件大小eg.xxGBxxMBxxKB
        /// </summary>
        /// <param name="FileFullPath">文件全路径</param>
        /// <returns>string</returns>
        public static string GetFileSizeAll(string FileFullPath)
        {
        ...
        public static void WriteFile(string FileFullPath, string Strings)
        {
            ...
            StreamWriter sw = new StreamWriter(FileFullPath, false, DefaultEncoding);
            sw.Write(Strings);
            sw.Flush();
            sw.Close();
            sw.Dispose();
        ...
        public static string ReadFile(string FileFullPath)
        {
            ...
            {
                StreamReader fr = new StreamReader(FileFullPath, DefaultEncoding);
                stemp = fr.ReadToEnd();
                fr.Close();
                fr.Dispose();
            }
