...
namespace HN863Soft.ISS.BLL
{
	...
	{
		private readonly HN863Soft.ISS.DAL.ServiceInfo dal=new HN863Soft.ISS.DAL.ServiceInfo();
		public ServiceInfo()
		{}
		#region  BasicMethod
        ...
        //{
        //    return dal.DeleteList(HN863Soft.ISS.Common.PageTemplate.SafeLongFilter(Idlist, 0));
        //}
        ...
        ///// 得到一个对象实体，从缓存中
        ///// </summary>
        //public HN863Soft.ISS.Model.ServiceInfo GetModelByCache(int Id)
        //{
			
        //    string CacheKey = "ServiceInfoModel-" + Id;
        ...
        //        catch{}
        //    }
        //    return (HN863Soft.ISS.Model.ServiceInfo)objModel;
        //}
		...
		/// 获得数据列表
		/// </summary>
		public List<HN863Soft.ISS.Model.ServiceInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<HN863Soft.ISS.Model.ServiceInfo> DataTableToList(DataTable dt)
		{
			List<HN863Soft.ISS.Model.ServiceInfo> modelList = new List<HN863Soft.ISS.Model.ServiceInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				HN863Soft.ISS.Model.ServiceInfo model;
        ...
        {
           return dal.UpdateCondition(model);
        }
