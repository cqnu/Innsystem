...
namespace HN863Soft.ISS.BLL
{
	...
	{
		private readonly HN863Soft.ISS.DAL.ArticleAttributeValue dal=new HN863Soft.ISS.DAL.ArticleAttributeValue();
		...
		/// 获得数据列表
		/// </summary>
		public List<HN863Soft.ISS.Model.ArticleAttributeValue> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<HN863Soft.ISS.Model.ArticleAttributeValue> DataTableToList(DataTable dt)
		{
			List<HN863Soft.ISS.Model.ArticleAttributeValue> modelList = new List<HN863Soft.ISS.Model.ArticleAttributeValue>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				HN863Soft.ISS.Model.ArticleAttributeValue model;
