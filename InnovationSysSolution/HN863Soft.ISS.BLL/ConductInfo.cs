...
namespace HN863Soft.ISS.BLL
{
	...
	{
		private readonly HN863Soft.ISS.DAL.ConductInfo dal=new HN863Soft.ISS.DAL.ConductInfo();
		public ConductInfo()
		{}
        #region  BasicMethod
        ...
        ///// 得到一个对象实体，从缓存中
        ///// </summary>
        //public HN863Soft.ISS.Model.ConductInfo GetModelByCache(int Id)
        //{

        //    string CacheKey = "ConductInfoModel-" + Id;
        ...
        //        catch { }
        //    }
        //    return (HN863Soft.ISS.Model.ConductInfo)objModel;
        //}
        ...
        /// 获得数据列表
        /// </summary>
        public List<HN863Soft.ISS.Model.ConductInfo> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<HN863Soft.ISS.Model.ConductInfo> DataTableToList(DataTable dt)
        {
            List<HN863Soft.ISS.Model.ConductInfo> modelList = new List<HN863Soft.ISS.Model.ConductInfo>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                HN863Soft.ISS.Model.ConductInfo model;
