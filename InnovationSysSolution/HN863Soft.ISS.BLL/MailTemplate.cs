...
namespace HN863Soft.ISS.BLL
{
	...
	public partial class MailTemplate
	{
		...
		private readonly HN863Soft.ISS.DAL.MailTemplate dal=new HN863Soft.ISS.DAL.MailTemplate();
		public MailTemplate(){}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<HN863Soft.ISS.Model.MailTemplate> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<HN863Soft.ISS.Model.MailTemplate> DataTableToList(DataTable dt)
		{
			List<HN863Soft.ISS.Model.MailTemplate> modelList = new List<HN863Soft.ISS.Model.MailTemplate>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				HN863Soft.ISS.Model.MailTemplate model;
