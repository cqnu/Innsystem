...
namespace HN863Soft.ISS.Web.Notice
{
    public partial class List : ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                if (!ChkManageLevel("ChannelNoticeList", EnumsHelper.ActionEnum.View.ToString())) //检查权限
                {
        ...
        public void BindData()
        {
            ...
            {
                //查询条件
                strWhere.AppendFormat("n.PublishContent like '%{0}%'", txtKeywords.Text.Trim());
            }
            ...
            string pageUrl = Utils.CombUrlTxt("Notice_List.aspx", "keywords={0}&page={1}", this.keywords, "__id__");
        ...
        {
            if (!ChkManageLevel("ChannelNoticeList", EnumsHelper.ActionEnum.Delete.ToString())) //检查权限
            {
                ShowMsgHelper.ShowScript("showWarningMsg('您没有管理该页面的权限');");
                return;
            }
            ...
            //ShowScriptMsg("删除数据成功！", "Notice_List.aspx", "parent.loadMenuTree");
            ShowMsgHelper.ShowScript("location.href='/Manage/Notice/Notice_List.aspx';");
        }
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("Notice_List.aspx", "keywords={0}", this.keywords));
