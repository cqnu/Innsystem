<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Notice_Modify.aspx.cs" Inherits="HN863Soft.ISS.Web.Notice.Modify" Title="修改页" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>发布内容</dt>
                <dd>
                    <asp:TextBox ID="txtPublishContent" runat="server" CssClass="input" datatype="*1-500" TextMode="MultiLine" MaxLength="500"  Width="70%" Height="40%"></asp:TextBox>
