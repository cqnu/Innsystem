<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NavEdit.aspx.cs" Inherits="_863soft.ISS.Web.Manage.Settings.NavEdit" %>
...
<!--导航栏-->
<div class="location">
  <a href="NavList.aspx" class="back"><i></i><span>返回列表页</span></a>
  <a href="../Center.aspx" class="home"><i></i><span>首页</span></a>
  <i class="arrow"></i>
  <a href="NavList.aspx"><span>导航列表</span></a>
  <i class="arrow"></i>
  <span>编辑后台导航</span>
</div>
