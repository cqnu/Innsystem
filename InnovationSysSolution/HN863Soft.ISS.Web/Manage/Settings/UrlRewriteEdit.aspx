<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UrlRewriteEdit.aspx.cs" Inherits="_863soft.ISS.Web.Manage.Settings.UrlRewriteEdit" %>
...
<!--导航栏-->
<div class="location">
  <a href="UrlRewriteList.aspx" class="back"><i></i><span>返回列表页</span></a>
  <a href="../Center.aspx" class="home"><i></i><span>首页</span></a>
  <i class="arrow"></i>
  <a href="UrlRewriteList.aspx"><span>URL配置</span></a>
  <i class="arrow"></i>
  <span>编辑URL配置</span>
</div>
