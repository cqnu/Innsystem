<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UrlRewriteList.aspx.cs" Inherits="_863soft.ISS.Web.Manage.Settings.UrlRewriteList" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="UrlRewriteEdit.aspx?action=<%=EnumsHelper.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
...
<div class="table-container">
  ...
  <ItemTemplate>
    <tr>
      ...
      <td align="center"><a href="UrlRewriteEdit.aspx?action=<%#EnumsHelper.ActionEnum.Edit %>&name=<%#Eval("name")%>">修改</a></td>
    </tr>
  </ItemTemplate>
  <FooterTemplate>
