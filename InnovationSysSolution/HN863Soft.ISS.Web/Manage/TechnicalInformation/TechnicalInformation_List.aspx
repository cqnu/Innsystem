<%@ Page Title="TechnicalInformation" Language="C#" AutoEventWireup="true" CodeBehind="TechnicalInformation_List.aspx.cs" Inherits="HN863Soft.ISS.Web.TechnicalInformation.List" %>
        ...
        <div id="floatHead" class="toolbar-wrap">
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            <li><a class="add" href="TechnicalInformation_Add.aspx"><i></i><span>新增</span></a></li>
                ...
                <ItemTemplate>
                    <tr>
                        <td align="center">
                            ...
                            <asp:HiddenField ID="hid2" Value='<%#Eval("Eject")%>' runat="server" />
                        </td>
                        <td align="center"><%#Eval("rowid")%></td>
                        <td align="center"><%#Eval("hits")%></td>
                        <td align="center" title='<%#Eval("EntryName")%>'><%#Eval("EntryName").ToString().Length>12?Eval("EntryName").ToString().Substring(0,12)+"...":Eval("EntryName")%></td>
                        <td align="center" title='<%#Eval("Keyword")%>'><%#Eval("Keyword").ToString().Length>10?Eval("Keyword").ToString().Substring(0,10)+"...":Eval("Keyword")%></td>
                     ...
                     <td align="center">
                        ...
                        <td align="center" title='<%#Eval("Describe")%>'><%#Eval("Describe").ToString().Length>6?Eval("Describe").ToString().Substring(0,6)+"...":Eval("Describe")%></td>
                        <td align="center" style="white-space: nowrap; word-break: break-all; overflow: hidden;">
                            <a href="/Web/TechnicalInformation/TechnicalInformation_Show.aspx?id=<%#Eval("ID")%>&category=1">查看</a>
                            <a href="TechnicalInformation_Modify.aspx?id=<%#Eval("ID")%>&category=1">编辑</a>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
            ...
            if (a == "No") {
                if ($('#txtDescribe').val().trim().toString() == "") {
                    ...
                    $.ajax({
                        ...
                        data: { id: $('#hid1').val(), state: 2, Describe: $('#txtDescribe').val(), TableName: "TechnicalInformation", PageName: "技术信息管理" },
                ...
                $.ajax({
                    type: "POST",
                    url: "../../WebService/UpdateHandler.ashx",
                    data: { id: $('#hid1').val(), state: 1, Describe: $('#txtDescribe').val(), TableName: "TechnicalInformation", PageName: "技术信息管理" },
                    success: function (msg) {
                        alert(msg);
