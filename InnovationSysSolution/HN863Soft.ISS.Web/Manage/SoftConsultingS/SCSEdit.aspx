<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SCSEdit.aspx.cs" ValidateRequest="false" Inherits="HN863Soft.ISS.Web.Manage.SoftConsultingS.SCSEdit" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="SCSList.aspx" class="back"><i></i><span>返回列表页</span></a>
            <a href="../Center.aspx" class="home"><i></i><span>首页</span></a>
            <i class="arrow"></i>
            <a href="SCSList.aspx"><span>双软认定咨询发布列表</span></a>
            <i class="arrow"></i>
            <span>编辑双软认定咨询发布信息</span>
        </div>
