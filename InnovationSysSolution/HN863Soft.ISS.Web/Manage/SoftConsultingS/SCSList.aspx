<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SCSList.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.SoftConsultingS.SCSList" %>
<%@ Import Namespace="HN863Soft.ISS.Common" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>双软认定咨询发布列表</title>
        ...
        <div id="floatHead" class="toolbar-wrap">
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            <li><a class="add" href="SCSEdit.aspx?action=<%=EnumsHelper.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
                            <li>
            ...
            <asp:Repeater ID="rptList" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center"><a href="SCSShow.aspx?action=<%#EnumsHelper.ActionEnum.View %>&id=<%#Eval("Id")%>">查看</a>&nbsp;<a href="SCSEdit.aspx?action=<%#EnumsHelper.ActionEnum.Edit %>&id=<%#Eval("Id")%>">修改</a>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
