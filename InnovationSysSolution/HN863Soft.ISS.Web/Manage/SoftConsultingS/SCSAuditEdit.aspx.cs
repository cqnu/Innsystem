...
{
    public partial class SCSAuditEdit : ManagePage
    {
        #region 函数
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                if (!ChkManageLevel("ChannelSCSAuditList", EnumsHelper.ActionEnum.Edit.ToString())) //检查权限
                {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                if (!ChkManageLevel("ChannelSCSAuditList", EnumsHelper.ActionEnum.Add.ToString())) //检查权限
                {
                    ShowMsgHelper.ShowScript("showWarningMsg('您没有管理该页面的权限');");
                    return;
                }
