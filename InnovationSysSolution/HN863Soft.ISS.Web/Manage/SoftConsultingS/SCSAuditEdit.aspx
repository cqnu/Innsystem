<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SCSAuditEdit.aspx.cs" ValidateRequest ="false" Inherits="HN863Soft.ISS.Web.Manage.SoftConsultingS.SCSAuditEdit" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>关键词</dt>
                <dd>
                    <asp:TextBox ID="txtKeyWord" runat="server" CssClass="input normal" datatype="*1-100"></asp:TextBox>
            ...
            <dl>
                <dt>服务咨询电话</dt>
                <dd>
                    <asp:TextBox runat="server" ID="txtPhone" CssClass="input normal" datatype="/^[0-9]{6,12}$/" nullmsg="请输入咨询电话" errormsg="请输入咨询电话" sucmsg=" " />
                </dd>
            </dl>
        </div>
