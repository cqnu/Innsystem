<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.Inspection.List" %>
        ...
        <div id="floatHead" class="toolbar-wrap">
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            <li><a class="add" href="Edit.aspx?action=<%=EnumsHelper.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
            ...
            <asp:Repeater ID="rptList" runat="server">
                <HeaderTemplate>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
                        <tr>
                            ...
                            <th align="left" width="12%">服务标题</th>
                            <th align="left" width="12%">服务范围</th>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td><%#string.Format("{0:g}",Eval("CreatTime"))%></td>
                        <td align="center">
                            <%#Eval("Visite").ToString().Trim() == "0" ? "未审核" : "已审核"%></td>

                        <td align="center"><a href="Edit.aspx?action=<%#EnumsHelper.ActionEnum.Edit %>&id=<%#Eval("ID")%>">修改</a>  <a href="Detail.aspx?action=<%#EnumsHelper.ActionEnum.View %>&id=<%#Eval("ID")%>">详细回复</a></td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
