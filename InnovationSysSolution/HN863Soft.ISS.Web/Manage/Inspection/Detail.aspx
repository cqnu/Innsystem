<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="Detail.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.Inspection.Detail" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="location">
            ...
            <i class="arrow"></i>
            <a href="List.aspx"><span>服务信息管理列表</span></a>
            <i class="arrow"></i>
            <span>编辑服务信息</span>
        </div>
