<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false"
    CodeBehind="Ariticle_Add.aspx.cs" Inherits="HN863Soft.ISS.Web.userAriticle.Add" Title="增加页" %>
        ...
        <div class="tab-content">
            ...
            <dl>
                ...
                <dd>
                    ...
                    <asp:TextBox ID="container" name="content" TextMode="MultiLine" runat="server" MaxLength="500" datatype="*" sucmsg=" " Width="100%" Height="40%"></asp:TextBox>
                    <span class="Validform_checktip"></span>
                </dd>
            </dl>
        </div>
