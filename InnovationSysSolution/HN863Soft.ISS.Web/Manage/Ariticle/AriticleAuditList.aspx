<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AriticleAuditList.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.Ariticle.AriticleAuditList" %>

<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="viewport" content="width=device-width,minimum-scale=1.0,maximum-scale=1.0,initial-scale=1.0,user-scalable=no" />
    <meta name="apple-mobile-web-app-capable" content="yes" />
    <title>工业设计审核管理</title>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center" style="white-space: nowrap; word-break: break-all; overflow: hidden;">
                            <asp:LinkButton ID="LinkButton1" Text="查看" runat="server" PostBackUrl='<%#"AriticleAuditShow.aspx?id="+Eval("ID") + "&category=1" %>'></asp:LinkButton>
                            <asp:LinkButton ID="LinkButton2" Text="修改" runat="server" PostBackUrl='<%#"AriticleAuditModify.aspx?id="+Eval("ID")+"&category=1" %>' Visible='<%# Eval("State").ToString()=="1"? false:true %>'></asp:LinkButton>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
