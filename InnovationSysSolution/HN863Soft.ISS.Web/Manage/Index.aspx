<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.Index" %>
...
<script type="text/javascript">
    ...
    $(function () {        //检测IE
        ...
        //window.setInterval(getData, 6000); //每6秒循环执行！！  
    });
...
<form id="form1" runat="server">
  ...
  <div class="main-top">
    ...
    <div class="nav-right">
      <div class="info">
        <i></i>
        <span style="font-size:16px;text-align:center;margin-top:6px;">
          您好：<%=manageInfo.UserName %><br>
        </span>
      </div>
      <div class="option">
        <i></i>
        <div class="drop-wrap">
          ...
          <ul class="item">
            <li>
              <a href="../Web/index.html" >预览网站</a>
            </li>
            <li>
              <a href="Center.aspx" target="mainframe">管理中心</a>
            </li>
            <li>
              <a href="SysManage/ManagerPassword.aspx" onclick="linkMenuTree(false, '');" target="mainframe">修改密码</a>
            </li>
            <li>
