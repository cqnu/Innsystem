...
{
    public partial class LinkPatent_Show : ManagePage
    {
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("LinkPatent_Show.aspx", "keywords={0}", txtKeywords.Text));
        }
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("LinkPatent_Show.aspx", "keywords={0}", this.keywords));
        }
        ...
        public void BindData()
        {
            ...
            string pageUrl = Utils.CombUrlTxt("LinkPatent_Show.aspx", "keywords={0}&page={1}", this.keywords, "__id__");
