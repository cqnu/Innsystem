<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="Management_Modify.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.Management.Management_Modify" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>标题</dt>
                <dd>
                    <asp:TextBox ID="txtTitle" runat="server" CssClass="input normal" datatype="*1-200" Height="5%" Width="70%"></asp:TextBox>
            ...
            <dl>
                ...
                <dd>
                    ...
                    <%--                     <textarea runat="server"  CssClass="input normal" id="traContent" name="traContent"></textarea><span class="Validform_checktip">*内容必填</span>--%>
                </dd>
            </dl>
            <dl>
                <dt>备注</dt>
                <dd>
                    <asp:TextBox ID="txtRemarks" CssClass="input normal" runat="server" MaxLength="200" TextMode="MultiLine" Height="20%" Width="70%"></asp:TextBox>
