<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActiveAuditDetail.aspx.cs"  ValidateRequest="false" Inherits="HN863Soft.ISS.Web.Manage.MeetingActivity.ActiveAuditDetail" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <!--导航栏-->
        <div class="location">
            <a href="ActiveAuditList.aspx" class="back"><i></i><span>返回列表页</span></a>
            <a href="../Center.aspx" class="home"><i></i><span>首页</span></a>
            <i class="arrow"></i>
            <a href="ActiveAuditList.aspx"><span>难题吐槽审核列表</span></a>
            <i class="arrow"></i>
            <span>查看难题吐槽审核信息</span>
        </div>
        ...
        <div class="tab-content">
            <div>
                <dl>
                    <dt>悬赏</dt>
                    <dd><label runat="server" id="lblPoint"></label> 积分</dd>
                </dl>
                <dl>
                    <dt>标题</dt>
                    <dd><label runat="server" id="lblTitle"></label></dd>
                </dl>
                <dl>
                    <dt>内容</dt>
                    <dd><div runat="server" id="Dcontent"></div></dd>
                </dl>
            </div>
            <dl>
                <dt>最新评论:</dt>
            ...
            <dl>
                <dt></dt>
                <dd><div class="menu-list" style="position: absolute; bottom: 0px; right: 10px">
                                    ...
                                    <tr>
                                        ...
                                        <td style="height: 20px">
                                            <div style="position: relative">
                                                回复于：<%# Eval("CreateTime")%><div style="position: absolute; right: 10px; top: 1px">
                                                    #<%#Eval("Floor") %>&nbsp; 得分：<%#Eval("Score") %></div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
            ...
            <div style="width: 100%; position: relative;">
                <div class="Img" style="float: left; display: inline; width: 10%">
                     <img  src="#" style="height:100px;width:100px;" id="UserAvator" runat="server" />
                </div>
                <div style="float: left; width: 80%">
                    <a name="txtContent"></a>
                    <textarea runat="server" id="txtContent" name="txtContent" CssClass="input normal" datatype="*" style="height: 200px; width: 100%"></textarea><span class="Validform_checktip">*发表</span>
                        <script type="text/javascript">
