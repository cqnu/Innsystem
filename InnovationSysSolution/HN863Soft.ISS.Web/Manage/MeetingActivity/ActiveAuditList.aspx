<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActiveAuditList.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.MeetingActivity.ActiveAuditList" %>
            ...
            <asp:Repeater ID="rptList" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center">
                            <asp:LinkButton ID="LinkButton1" Text="查看" runat="server" PostBackUrl='<%#"ActiveAuditDetail.aspx?action=" + EnumsHelper.ActionEnum.View + "&id=" +Eval("ID")%>'></asp:LinkButton>
                            <asp:LinkButton ID="LinkButton2" Text="修改" runat="server" PostBackUrl='<%#"ActiveAuditEdit.aspx?action=" + EnumsHelper.ActionEnum.Edit + "&id=" +Eval("ID")%>' Visible='<%# Eval("IsVis").ToString()=="1"? false:true %>'></asp:LinkButton>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
