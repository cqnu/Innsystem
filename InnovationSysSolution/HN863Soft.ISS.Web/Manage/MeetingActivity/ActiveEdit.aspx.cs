...
{
    public partial class ActiveEdit : ManagePage
    {
        #region 函数
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (action == EnumsHelper.ActionEnum.Edit.ToString()) //修改
            {
                //ChkManageLevel("ActiveList", EnumsHelper.ActionEnum.Edit.ToString()); //检查权限
                if (!DoEdit(this.id))
                {
            ...
            else //添加
            {
                ...
                {
                    ShowMsgHelper.ShowScript("showWarningMsg('积分已超出账户余额！余额剩余:" + userModel.Point + " 积分');");
                    return;
                }
