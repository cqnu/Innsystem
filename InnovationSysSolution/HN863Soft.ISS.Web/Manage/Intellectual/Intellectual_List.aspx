<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Intellectual_List.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.Intellectual.Intellectual_List" %>
        ...
        <div id="floatHead" class="toolbar-wrap">
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            <li><a class="add" href="Intellectual_Add.aspx"><i></i><span>新增</span></a></li>
                            <li>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center" style="white-space: nowrap; word-break: break-all; overflow: hidden;">
                            <a href="Intellectual_Show.aspx?id=<%#Eval("ID")%>">查看</a>&nbsp;
                            <a href="Intellectual_Modify.aspx?id=<%#Eval("ID")%>">修改</a>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
