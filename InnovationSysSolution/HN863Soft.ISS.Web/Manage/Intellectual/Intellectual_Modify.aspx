<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="Intellectual_Modify.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.Intellectual.Intellectual_Modify" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="location">
            ...
            <i class="arrow"></i>
            <a href="Intellectual_List.aspx"><span>知识产权列表</span></a>
            <i class="arrow"></i>
            <span>修改知识产权</span>
        </div>
        ...
        <div class="tab-content">
            ...
            <dl>
                ...
                <dd>
                    ...
                    <%--   <textarea runat="server" id="traContent" name="traContent" Width="100%" Height="600px"></textarea><span class="Validform_checktip">*机构或专家证明文件必填</span>--%>
