<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="Intellectual_Add.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.Intellectual.Intellectual_Add" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="Intellectual_List.aspx" class="back"><i></i><span>返回列表页</span></a>
            <a href="../Center.aspx" class="home"><i></i><span>首页</span></a>
            <i class="arrow"></i>
            <a href="Intellectual_List.aspx"><span>知识产权发布列表</span></a>
            <i class="arrow"></i>
            <span>添加知识产权发布信息</span>
        </div>
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>名称</dt>
                <dd>
                    <asp:TextBox ID="txtTitle" runat="server" CssClass="input normal" datatype="*1-100"></asp:TextBox>
            ...
            <dl>
                <dt>内容</dt>
                <dd>
                    <%-- <asp:TextBox runat="server" id="txtContent" name="txtContent"  datatype="*" nullmsg ="请输入内容" width="100%" height="600px"></asp:TextBox>--%>
                    <asp:TextBox ID="container" name="content" TextMode="MultiLine" runat="server" datatype="*" Width="100%" Height="300px"></asp:TextBox>
                    <%-- <textarea id="container" runat="server" name="content"></textarea>--%>
                    <%-- <asp:textarea ID="traContent" name="traContent"  runat="server" sucmsg=" " Width="100%" Height="600px"></asp:textarea>--%>
