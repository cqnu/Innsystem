<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HSECEdit.aspx.cs" ValidateRequest="false" Inherits="HN863Soft.ISS.Web.Manage.HSEConsulting.HSECEdit" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="HSECList.aspx" class="back"><i></i><span>返回列表页</span></a>
            <a href="../Center.aspx" class="home"><i></i><span>首页</span></a>
            <i class="arrow"></i>
            <a href="HSECList.aspx"><span>高企认定咨询发布列表</span></a>
            <i class="arrow"></i>
            <span>编辑高企认定咨询发布信息</span>
        </div>
