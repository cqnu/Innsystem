<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HSECAuditShow.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.HSEConsulting.HSECAuditShow" %>
<!DOCTYPE html>
<html>
<head>
    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>服务咨询电话</dt>
                <dd>
                    <asp:TextBox runat="server" ID="txtPhone"  CssClass="input normal"  errormsg="请输入咨询电话" sucmsg=" " />
                </dd>
            </dl>
        </div>
