<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HSECAuditEdit.aspx.cs" ValidateRequest="false" Inherits="HN863Soft.ISS.Web.Manage.HSEConsulting.HSECAuditEdit" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="HSECAuditList.aspx" class="back"><i></i><span>返回列表页</span></a>
            <a href="../Center.aspx" class="home"><i></i><span>首页</span></a>
            <i class="arrow"></i>
            <a href="HSECAuditList.aspx"><span>高企认定咨询审核列表</span></a>
            <i class="arrow"></i>
            <span>编辑高企认定咨询审核信息</span>
        </div>
        ...
        <div id="floatHead" class="content-tab-wrap">
            <div class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a class="selected" href="javascript:;">高企认定咨询信息</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="tab-content">
            ...
            <dl>
                <dt>服务介绍</dt>
                <dd>
                    <textarea runat="server" id="txtContent" CssClass="input normal" datatype="*" name="txtContent" style="height: 200px; width: 80%"></textarea><span class="Validform_checktip">*服务介绍必填</span>
            ...
            <dl>
                <dt>团队介绍</dt>
                <dd>
                    <textarea runat="server" id="txaIntroduction" CssClass="input normal" datatype="*" name="txaIntroduction" style="height: 200px; width: 80%"></textarea><span class="Validform_checktip">*服务介绍必填</span>
                    <script type="text/javascript">
            ...
            <dl>
                <dt>成功案例</dt>
                <dd>
                    <textarea runat="server" id="txaExample" CssClass="input normal" datatype="*" name="txaExample" style="height: 200px; width: 80%"></textarea><span class="Validform_checktip">*服务介绍必填</span>
                    <script type="text/javascript">
            ...
            <dl>
                <dt>服务咨询电话</dt>
                <dd>
                    <asp:TextBox runat="server" ID="txtPhone" CssClass="input normal" datatype="/^[0-9]{6,12}$/" errormsg="请输入咨询电话" nullmsg="请输入咨询电话" sucmsg=" " />
                </dd>
            </dl>
        </div>
