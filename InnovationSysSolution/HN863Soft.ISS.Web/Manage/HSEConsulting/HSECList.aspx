<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HSECList.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.HSEConsulting.HSECList" %>
        ...
        <div id="floatHead" class="toolbar-wrap">
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            <li><a class="add" href="HSECEdit.aspx?action=<%=EnumsHelper.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
                            <li>
            ...
            <asp:Repeater ID="rptList" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center">
                            <a href="HSECShow.aspx?action=<%#EnumsHelper.ActionEnum.View %>&id=<%#Eval("Id")%>">查看</a>&nbsp;
                            <a href="HSECEdit.aspx?action=<%#EnumsHelper.ActionEnum.Edit %>&id=<%#Eval("Id")%>">修改</a>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
