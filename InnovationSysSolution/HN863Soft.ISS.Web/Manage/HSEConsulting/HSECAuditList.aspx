<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HSECAuditList.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.HSEConsulting.HSECAuditList" %>
            ...
            <asp:Repeater ID="rptList" runat="server">
                <HeaderTemplate>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
                        <tr>
                            ...
                            <th align="center" width="12%">服务名称</th>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center">
                            <asp:LinkButton ID="LinkButton1" Text="查看" runat="server" PostBackUrl='<%#"HSECAuditShow.aspx?action=" + EnumsHelper.ActionEnum.View + "&id=" +Eval("ID")%>'></asp:LinkButton>
                            <asp:LinkButton ID="LinkButton2" Text="修改" runat="server" PostBackUrl='<%#"HSECAuditEdit.aspx?action=" + EnumsHelper.ActionEnum.Edit + "&id=" +Eval("ID") %>' Visible='<%# Eval("IsVis").ToString()=="1"? false:true %>'></asp:LinkButton>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
