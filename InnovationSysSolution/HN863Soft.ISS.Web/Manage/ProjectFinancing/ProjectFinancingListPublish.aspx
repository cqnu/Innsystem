<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectFinancingListPublish.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.ProjectFinancing.ProjectFinancingListPublish" %>
        ...
        <div id="floatHead" class="toolbar-wrap">
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            <li><a class="add" href="ProjectFinancingAddPublish.aspx"><i></i><span>新增</span></a></li>
                            <li>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center" style="white-space: nowrap; word-break: break-all; overflow: hidden;">
                            <a href="ProjectFinancing_Show.aspx?id=<%#Eval("ID")%>">查看</a>
                            <a href="ProjectFinancing_Modify.aspx?id=<%#Eval("ID")%>&category=1">修改</a>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
