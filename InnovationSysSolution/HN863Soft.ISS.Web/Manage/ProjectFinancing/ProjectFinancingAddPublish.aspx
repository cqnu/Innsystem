<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="ProjectFinancingAddPublish.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.ProjectFinancing.ProjectFinancing_Add" %>
...
<%--            <dl>
            ...
            <dl>
                <dt>项目封面</dt>
                <dd>
                    <asp:FileUpload ID="FileUpload1" accept=".jpeg,.png,.jpg" datatype="*" CssClass="upload-box" nullmsg="请上传图片" runat="server" onchange="show(this.value)" />
