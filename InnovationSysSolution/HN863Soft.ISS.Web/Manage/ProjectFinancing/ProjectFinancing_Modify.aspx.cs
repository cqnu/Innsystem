...
// 文件名（File Name）：ProjectFinancing_Modify.cs
// 作者（Author）：邹峰
// 功能（Function）：编辑众筹信息
...
{
    public partial class ProjectFinancing_Modify : ManagePage
    {
        #region 变量
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                if (!ChkManageLevel("ChannelProjectFinancingList", EnumsHelper.ActionEnum.Edit.ToString())) //检查权限
                {
