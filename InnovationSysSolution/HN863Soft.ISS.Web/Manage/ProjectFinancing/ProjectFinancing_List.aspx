                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center" style="white-space: nowrap; word-break: break-all; overflow: hidden;">
                            ...
                            <asp:LinkButton Text="修改" runat="server" PostBackUrl='<%#"ProjectFinancingModifyPublish.aspx?id="+Eval("ID")+"&category=1" %>' Visible='<%# Eval("State").ToString()=="1"? false:true %>'></asp:LinkButton>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
