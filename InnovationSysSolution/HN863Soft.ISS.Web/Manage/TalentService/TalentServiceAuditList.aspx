<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TalentServiceAuditList.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.TalentService.TalentServiceAuditList" %>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center" style="white-space: nowrap; word-break: break-all; overflow: hidden;">
                            <asp:LinkButton ID="LinkButton1" Text="查看" runat="server" PostBackUrl='<%#"TalentServiceAuditShow.aspx?id=" + Eval("ID") + "&category=1"%>'></asp:LinkButton>
                            <asp:LinkButton ID="LinkButton2" Text="修改" runat="server" PostBackUrl='<%#"TalentServiceAuditModify.aspx?id="+Eval("ID")+"&category=1" %>' Visible='<%# Eval("State").ToString()=="1"? false:true %>'></asp:LinkButton>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
