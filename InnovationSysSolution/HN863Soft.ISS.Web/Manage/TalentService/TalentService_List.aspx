<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TalentService_List.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.TalentService.TalentService_List" %>
        ...
        <div id="floatHead" class="toolbar-wrap">
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            <li><a class="add" href="TalentService_Add.aspx"><i></i><span>新增</span></a></li>
                            <li>
                ...
                <ItemTemplate>
                    ...
                    <%--    <td align="center"><%#Eval("hits")%></td>--%>
                        ...
                        <td align="center" style="white-space: nowrap; word-break: break-all; overflow: hidden;">
                            <a href="TalentService_Show.aspx?id=<%#Eval("ID")%>&category=1">查看</a>
                            <a href="TalentService_Modify.aspx?id=<%#Eval("ID")%>&category=1">修改</a>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
