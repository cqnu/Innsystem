<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="TalentService_Show.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.TalentService.TalentService_Show" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="TalentService_List.aspx" class="back"><i></i><span>返回列表页</span></a>
            <a href="../Center.aspx" class="home"><i></i><span>首页</span></a>
            <i class="arrow"></i>
            <a href="TalentService_List.aspx"><span>人才服务发布列表</span></a>
            <i class="arrow"></i>
            <span>查看人才服务发布信息</span>
        </div>
        ...
        <dl>
            <dt>内容</dt>
            <dd>
                <asp:TextBox ID="container" name="content" TextMode="MultiLine" runat="server" sucmsg=" " Width="100%" Height="300px"></asp:TextBox>
            </dd>
        </dl>
        </div>
        <!--/内容-->
