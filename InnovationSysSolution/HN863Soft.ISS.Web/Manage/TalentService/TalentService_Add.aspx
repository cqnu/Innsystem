<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="TalentService_Add.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.TalentService.TalentService_Add" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>标题</dt>
                <dd>
                    <asp:TextBox ID="txtTitle" runat="server" CssClass="input" datatype="*1-100" Height="5%" Width="70%"></asp:TextBox>
