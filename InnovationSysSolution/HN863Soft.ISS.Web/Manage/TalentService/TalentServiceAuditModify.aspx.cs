...
{
    public partial class TalentServiceAuditMoify : ManagePage
    {
        #region 页面初期
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                if (!ChkManageLevel("ChannelTalentServiceAuditList", EnumsHelper.ActionEnum.Edit.ToString())) //检查权限
                {
        ...
        public void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (bll.Update(model))
            {
                ...
                Response.Redirect("TalentServiceAuditList.aspx");
            }
            else
            {
