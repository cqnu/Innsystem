...
// 文件名（File Name）：TechnicalService_Modify.cs
// 作者（Author）：邹峰
// 功能（Function）：编辑技术服务
...
{
    public partial class TechnicalService_Modify : ManagePage
    {
        #region 页面初期
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                if (!ChkManageLevel("ChannelTechnicalServiceList", EnumsHelper.ActionEnum.Edit.ToString())) //检查权限
                {
