<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TechnicalService_List.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.TechnicalService.TechnicalService_List" %>
        ...
        <div id="floatHead" class="toolbar-wrap">
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            <li><a class="add" href="TechnicalService_Add.aspx"><i></i><span>新增</span></a></li>
                            <li>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center" style="white-space: nowrap; word-break: break-all; overflow: hidden;">
                            ...
                            <a href="TechnicalService_Modify.aspx?id=<%#Eval("ID")%>&category=1">编辑</a>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
