<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="TechnicalService_Add.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.TechnicalService.TechnicalService_Add" %>
            ...
            <dl>
                ...
                <dd>
                    <div class="rule-single-select">
                        <asp:DropDownList ID="ddlType" runat="server" datatype="*" errormsg="请选择活动类型！" sucmsg=" "></asp:DropDownList>
                    </div>
                </dd>
            </dl>
