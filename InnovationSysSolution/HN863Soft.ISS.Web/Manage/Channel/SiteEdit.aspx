<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SiteEdit.aspx.cs" Inherits="_863soft.ISS.Web.Manage.Channel.SiteEdit" %>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#form1").initValidform();
        //初始化上传控件
        $(".upload-img").InitUploader({ sendurl: "../../WebService/UploadAjaxHandler.ashx", swf: "../../scripts/webuploader/uploader.swf" });
    });
</script>
</head>
...
<!--导航栏-->
<div class="location">
  <a href="SiteList.aspx" class="back"><i></i><span>返回列表页</span></a>
  <a href="../Center.aspx" class="home"><i></i><span>首页</span></a>
  <i class="arrow"></i>
  <a href="SiteList.aspx"><span>站点管理</span></a>
  <i class="arrow"></i>
  <span>编辑站点</span>
</div>
