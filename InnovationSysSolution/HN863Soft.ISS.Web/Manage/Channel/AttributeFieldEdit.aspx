<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AttributeFieldEdit.aspx.cs" Inherits="_863soft.ISS.Web.Manage.Channel.AttributeFieldEdit" %>
...
<!--导航栏-->
<div class="location">
  <a href="AttributeFieldList.aspx" class="back"><i></i><span>返回列表页</span></a>
  <a href="../Center.aspx" class="home"><i></i><span>首页</span></a>
  <i class="arrow"></i>
  <a href="AttributeFieldList.aspx"><span>扩展字段</span></a>
  <i class="arrow"></i>
  <span>编辑字段</span>
</div>
...
<div class="tab-content">
  ...
  <dl>
    <dt>字段列名</dt>
    <dd><asp:TextBox ID="txtName" runat="server" CssClass="input normal" datatype="/^[a-zA-Z0-9\-\_]{2,50}$/" sucmsg=" " ajaxurl="../../WebService/ManageAjaxHandler.ashx?action=attribute_field_validate"></asp:TextBox> <span class="Validform_checktip">*字母、下划线，不可修改</span></dd>
  </dl>
