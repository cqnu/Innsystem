<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AttributeFieldList.aspx.cs" Inherits="_863soft.ISS.Web.Manage.Channel.AttributeFieldList" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="AttributeFieldEdit.aspx?action=<%=EnumsHelper.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
...
<div class="table-container">
  ...
  <ItemTemplate>
    <tr>
      ...
      <td><%#Eval("Name")%></td>
      <td><%#Eval("Title")%></td>
      <td><%#GetTypeCn(Eval("ControlType").ToString())%></td>
      <td align="center"><%#Convert.ToInt32(Eval("IsRequired")) == 1 ? "√" : "×"%></td>
      ...
      <td align="center"><a href="AttributeFieldEdit.aspx?action=<%#EnumsHelper.ActionEnum.Edit %>&id=<%#Eval("ID")%>">修改</a></td>
    </tr>
  </ItemTemplate>
  <FooterTemplate>
