...
{
    public partial class EnterpriseRegistrationAuditModify : ManagePage
    {
        #region 变量
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                if (!ChkManageLevel("ChannelEnterpriseRegAuditList", EnumsHelper.ActionEnum.Edit.ToString())) //检查权限
                {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (bll.Update(model))
            {
                ...
                Response.Redirect("EnterpriseRegistrationAuditList.aspx");
            }
            else
            {
