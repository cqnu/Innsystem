<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="EnterpriseRegistration_Modify.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.EnterpriseRegistration.EnterpriseRegistration_Modify" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="EnterpriseRegistration_List.aspx" class="back"><i></i><span>返回列表页</span></a>
            <a href="../Center.aspx" class="home"><i></i><span>首页</span></a>
            <i class="arrow"></i>
            <a href="EnterpriseRegistration_List.aspx"><span>工商注册发布列表</span></a>
            <i class="arrow"></i>
            <span>修改工商注册发布信息</span>
        </div>
