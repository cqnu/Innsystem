<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnterpriseRegistrationAuditModify.aspx.cs" ValidateRequest="false" Inherits="HN863Soft.ISS.Web.Manage.EnterpriseRegistration.EnterpriseRegistrationAuditModify" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="EnterpriseRegistrationAuditList.aspx" class="back"><i></i><span>返回列表页</span></a>
            <a href="../Center.aspx" class="home"><i></i><span>首页</span></a>
            <i class="arrow"></i>
            <a href="EnterpriseRegistrationAuditList.aspx"><span>工商注册审核列表</span></a>
            <i class="arrow"></i>
            <span>修改工商注册审核信息</span>
        </div>
        ...
        <div id="floatHead" class="content-tab-wrap">
            <div class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a class="selected" href="javascript:;">工商注册信息</a></li>
                    </ul>
                </div>
            </div>
        </div>
