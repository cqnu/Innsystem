<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnterpriseRegistrationAuditShow.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.EnterpriseRegistration.EnterpriseRegistrationAuditShow" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="ProjectFinancingAuditList.aspx" class="back"><i></i><span>返回列表页</span></a>
            <a href="../Center.aspx" class="home"><i></i><span>首页</span></a>
            <i class="arrow"></i>
            <a href="ProjectFinancingAuditList.aspx"><span>工商注册审核列表</span></a>
            <i class="arrow"></i>
            <span>查看工商注册审核信息</span>
        </div>
