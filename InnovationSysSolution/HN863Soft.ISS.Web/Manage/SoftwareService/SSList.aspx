<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SSList.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.SoftwareService.SSList" %>
        ...
        <div id="floatHead" class="toolbar-wrap">
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            <li><a class="add" href="SSEdit.aspx?action=<%=EnumsHelper.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
                            <li>
            ...
            <asp:Repeater ID="rptList" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center">
                            <a href="SSDetail.aspx?action=<%#EnumsHelper.ActionEnum.View %>&id=<%#Eval("Id")%>">查看</a>&nbsp;
                            <a href="SSEdit.aspx?action=<%#EnumsHelper.ActionEnum.Edit %>&id=<%#Eval("Id")%>">修改</a>
