<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SSAuditDetail.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.SoftwareService.SSAuditDetail" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="SSAuditList.aspx" class="back"><i></i><span>返回列表页</span></a>
            <a href="../Center.aspx" class="home"><i></i><span>首页</span></a>
            <i class="arrow"></i>
            <a href="SSAuditList.aspx"><span>软件服务审核列表</span></a>
            <i class="arrow"></i>
            <span>查看软件服务审核信息</span>
        </div>
        ...
        <div class="tab-content">
            <dl>
                <dt>服务类型</dt>
                <dd>
                    <asp:DropDownList runat="server"  ReadOnly="true" ID="ddlType">
                    </asp:DropDownList>
                </dd>
            </dl>
            <dl>
                <dt>服务名称</dt>
                <dd>
                    <asp:TextBox runat="server" ID="txtTitle" TextMode="MultiLine" ReadOnly="true" CssClass="input normal" nullmsg="请填写服务名称信息" sucmsg=" "></asp:TextBox>
                </dd>
            </dl>
             <dl>
                <dt>软件Logo</dt>
            ...
            <dl>
                <dt>服务咨询电话</dt>
                <dd>
                    <asp:TextBox runat="server" ID="txtPhone" CssClass="input normal"  ReadOnly="true"  nullmsg="请输入咨询电话"  sucmsg=" " />
                </dd>
            </dl>
        </div>
