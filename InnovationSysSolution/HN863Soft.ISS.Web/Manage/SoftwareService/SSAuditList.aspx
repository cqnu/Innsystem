<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SSAuditList.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.SoftwareService.SSAuditList" %>
            ...
            <asp:Repeater ID="rptList" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center"><%# Eval("SName").ToString().Length>20? Eval("SName").ToString().Substring(0,20)+"...":Eval("SName").ToString()%></a></td>
                        <td align="center"><%#Convert.ToDateTime(Eval("CreateDate")).ToShortDateString()%></td>
                        <td align="center"><%#Eval("UserName")%></td>
                        <td align="center">
                            <%#  Convert.ToString(Eval("IsVis")) == "0" ? "未审核" : Convert.ToString(Eval("IsVis")) == "1" ? "已通过":"未通过"%>
                        </td>
                        ...
                        <td align="center">
                            <asp:LinkButton ID="LinkButton1" Text="查看" runat="server" PostBackUrl='<%#"SSAuditDetail.aspx?action=" + EnumsHelper.ActionEnum.View + "&id=" +Eval("ID")%>'></asp:LinkButton>
                            <asp:LinkButton ID="LinkButton2" Text="修改" runat="server" PostBackUrl='<%#"SSAuditEdit.aspx?action="+ EnumsHelper.ActionEnum.Edit + "&id=" +Eval("ID") %>' Visible='<%# Eval("IsVis").ToString()=="1"? false:true %>'></asp:LinkButton>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
