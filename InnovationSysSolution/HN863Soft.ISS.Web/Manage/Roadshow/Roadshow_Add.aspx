<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="Roadshow_Add.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.Roadshow.Roadshow_Add" %>
...
<%--            <dl>
            ...
            <dl>
                <dt>路演封面</dt>
                <dd>
                    <asp:FileUpload ID="FileUpload1" accept=".jpeg,.png,.jpg" runat="server" CssClass="upload-box" datatype="*" nullmsg="请上传图片" onchange="show(this.value)" />
            ...
            <dl>
                <dt></dt>
                <dd>
                    <asp:Image ID="Image1" runat="server" CssClass="photo-list" Height="200px" Width="300px" />
                </dd>
            </dl>
            <dl>
                <dt>路演主题</dt>
            ...
            <dl>
                ...
                <dd>
                    ...
                    <span class="Validform_checktip">*请填写机构名称。</span>
                </dd>
            </dl>
            <dl>
                <dt>路演关键词</dt>
            ...
            <dl>
                <dt>主讲人</dt>
                <dd>
                    <asp:TextBox ID="txtSpeaker" runat="server" CssClass="input normal" datatype="*1-10" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*请填写主讲人。</span>
                </dd>
            </dl>
            ...
            <dl>
                <dt>路演时间</dt>
                <dd>
                    <input id="startDate" runat="server" class="Wdate" datatype="*" type="text" onfocus="var endDate=$dp.$('endDate');WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',onpicked:function(){endDate.focus();},maxDate:'#F{$dp.$D(\'endDate\')}'})" />
                    至
                    <input id="endDate" runat="server" class="Wdate" datatype="*" nullmsg="请选择开始日期和结束日期" type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',minDate:'#F{$dp.$D(\'startDate\')}'})" />
                    <span class="Validform_checktip">*请填写申请路演时间</span>
                </dd>
            </dl>
            <dl>
                <dt>项目地点</dt>
        ...
        <div class="tab-content" style="display: none;">
            ...
            <dl>
                <dd>
                    ...
                    <video id="example_video_1" class="video-js vjs-default-skin" width="800" height="500">
                    </video>
                </dd>
            ...
            <dl>
                <dt>项目详情</dt>
                <dd>
                    <textarea runat="server" id="traContent" name="traContent" datatype="*" style="height: 1500px; width: 100%"></textarea>
                    <script type="text/javascript">
