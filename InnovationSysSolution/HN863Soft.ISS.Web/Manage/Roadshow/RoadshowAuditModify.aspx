<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoadshowAuditModify.aspx.cs" ValidateRequest="false" Inherits="HN863Soft.ISS.Web.Manage.Roadshow.RoadshowAuditModify" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <!--导航栏-->
        <div class="location">
            <a href="RoadshowAuditList.aspx" class="back"><i></i><span>返回列表页</span></a>
            <a href="../Center.aspx" class="home"><i></i><span>首页</span></a>
            <i class="arrow"></i>
            <a href="RoadshowAuditList.aspx"><span>路演审核管理</span></a>
            <i class="arrow"></i>
            <span>修改路演审核信息</span>
        </div>
...
<%--            <dl>
            ...
            <dl>
                <dt>路演封面</dt>
                <dd>
                    <asp:FileUpload ID="FileUpload1" accept=".jpeg,.png,.jpg" runat="server" CssClass="upload-box" onchange="show(this.value)" />
