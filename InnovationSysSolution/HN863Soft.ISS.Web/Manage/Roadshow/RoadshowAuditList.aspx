<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoadshowAuditList.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.Roadshow.RoadshowAuditList" %>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center" style="white-space: nowrap; word-break: break-all; overflow: hidden;">
                            <asp:LinkButton ID="LinkButton1" Text="查看" runat="server" PostBackUrl='<%#"RoadshowAuditShow.aspx?id="+Eval("ID")%>'></asp:LinkButton>
                            <asp:LinkButton ID="LinkButton2" Text="修改" runat="server" PostBackUrl='<%#"RoadshowAuditModify.aspx?id="+Eval("ID")+"&category=1" %>' Visible='<%# Eval("State").ToString()=="1"? false:true %>'></asp:LinkButton>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
