<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FiscalAuditList.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.Fiscal.FiscalAuditList" %>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center" style="white-space: nowrap; word-break: break-all; overflow: hidden;">
                            <asp:LinkButton ID="LinkButton1" Text="查看" runat="server" PostBackUrl='<%#"FiscalAuditShow.aspx?id="+Eval("ID")%>'></asp:LinkButton>
                            <asp:LinkButton ID="LinkButton2" Text="修改" runat="server" PostBackUrl='<%#"FiscalAuditModify.aspx?id="+Eval("ID")%>' Visible='<%# Eval("State").ToString()=="1"? false:true %>'></asp:LinkButton>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
