<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="Fiscal_Add.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.Fiscal.Fiscal_Add" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="Fiscal_List.aspx" class="back"><i></i><span>返回列表页</span></a>
            <a href="../Center.aspx" class="home"><i></i><span>首页</span></a>
            <i class="arrow"></i>
            <a href="Fiscal_List.aspx"><span>财税服务发布列表</span></a>
            <i class="arrow"></i>
            <span>添加财税服务发布信息</span>
        </div>
        ...
        <div id="floatHead" class="content-tab-wrap">
            <div class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a class="selected" href="javascript:;">财税服务信息</a></li>
                    </ul>
                </div>
            </div>
        </div>
