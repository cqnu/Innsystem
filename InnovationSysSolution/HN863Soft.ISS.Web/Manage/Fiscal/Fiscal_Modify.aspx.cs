...
{
    public partial class Fiscal_Modify : ManagePage
    {
        #region 变量
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                if (!ChkManageLevel("ChannelFiscalList", EnumsHelper.ActionEnum.Edit.ToString())) //检查权限
                {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (bll.Update(model))
            {
                ...
                Response.Redirect("Fiscal_List.aspx");
            }
            else
            {
