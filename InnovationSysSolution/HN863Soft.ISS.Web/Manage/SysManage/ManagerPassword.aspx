<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManagerPassword.aspx.cs" Inherits="_863soft.ISS.Web.Manage.SysManage.ManagerPassword" %>
...
<div class="tab-content">
  ...
  <dl>
    <dt>姓名</dt>
    <dd><asp:TextBox ID="txtRealName" ReadOnly="true" runat="server" CssClass="input normal"></asp:TextBox></dd>
  </dl>
  <dl>
    <dt>电话</dt>
    <dd><asp:TextBox ID="txtTelephone" ReadOnly="true"  runat="server" CssClass="input normal"></asp:TextBox></dd>
  </dl>
  <dl>
    <dt>邮箱</dt>
    <dd><asp:TextBox ID="txtEmail" ReadOnly="true"  runat="server" CssClass="input normal"></asp:TextBox></dd>
  </dl>
</div>
<!--/内容-->
