<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManagerEdit.aspx.cs" Inherits="_863soft.ISS.Web.Manage.SysManage.ManagerEdit" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="ManagerList.aspx" class="back"><i></i><span>返回列表页</span></a>
            <a href="../Center.aspx" class="home"><i></i><span>首页</span></a>
            <i class="arrow"></i>
            <a href="ManagerList.aspx"><span>用户管理列表</span></a>
            <i class="arrow"></i>
            <span>编辑用户</span>
        </div>
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>用户名</dt>
                <dd>
                    <asp:TextBox ID="txtUserName" runat="server" CssClass="input normal" datatype="/^[a-zA-Z0-9\-\_]{2,50}$/" sucmsg=" " ajaxurl="../../WebService/ManageAjaxHandler.ashx?action=manager_validate"></asp:TextBox>
            ...
            <dl>
                <dt>积分</dt>
                <dd>
                    <asp:TextBox ID="txtIntegral" MaxLength="6" runat="server" errormsg="请输入整数" sucmsg="" datatype="/^([1-9]\d{0,}|0)$/" CssClass="input normal"></asp:TextBox></dd>
            </dl>
            <dl>
                <dt>姓名</dt>
                <dd>
