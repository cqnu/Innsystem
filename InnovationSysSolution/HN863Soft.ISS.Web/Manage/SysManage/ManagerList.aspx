<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManagerList.aspx.cs" Inherits="_863soft.ISS.Web.Manage.SysManage.ManagerList" %>
        ...
        <div id="floatHead" class="toolbar-wrap">
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            <li><a class="add" href="ManagerEdit.aspx?action=<%=EnumsHelper.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
            ...
            <asp:Repeater ID="rptList" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td><a href="ManagerEdit.aspx?action=<%#EnumsHelper.ActionEnum.Edit %>&id=<%#Eval("ID")%>"><%# Eval("UserName") %></a></td>
                        <td><%# Eval("RealName") %></td>
                        ...
                        <td align="center"><a href="ManagerEdit.aspx?action=<%#EnumsHelper.ActionEnum.Edit %>&id=<%#Eval("ID")%>">修改</a></td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
