<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EIList.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.EnterIncubating.EIList" %>
            ...
            <asp:Repeater ID="rptList" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td><%# Eval("Name").ToString().Length>20?Eval("Name").ToString().Substring(0,20)+"...":Eval("Name").ToString() %></a></td>
                        ...
                        <td align="center"><a href="EIDetail.aspx?action=<%#EnumsHelper.ActionEnum.View %>&id=<%#Eval("Id")%>">查看</a> </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
