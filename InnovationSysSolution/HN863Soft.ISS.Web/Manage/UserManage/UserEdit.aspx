<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserEdit.aspx.cs" Inherits="HN863Soft.ISS.Web.Manage.Settings.UserEdit" %>
...
<!--导航栏-->
<div class="location">
  <a href="UserList.aspx" class="back"><i></i><span>返回列表页</span></a>
  <a href="../Center.aspx" class="home"><i></i><span>首页</span></a>
  <i class="arrow"></i>
  <a href="UserList.aspx"><span>用户信息</span></a>
  <i class="arrow"></i>
  <span>编辑用户</span>
</div>
...
<div id="floatHead" class="content-tab-wrap">
  <div class="content-tab">
    <div class="content-tab-ul-wrap">
      <ul>
        <li><a class="selected" href="javascript:;">编辑用户信息</a></li>
      </ul>
    </div>
  </div>
</div>
...
<div class="tab-content">
  <dl>
    <dt>用户角色</dt>
    <dd><asp:TextBox ID="tbUserRole" runat="server" CssClass="input normal" ReadOnly ="true" sucmsg=" "></asp:TextBox></dd>
  </dl> 
  <dl>
    <dt>用户名</dt>
    <dd><asp:TextBox ID="txtUserName" runat="server" CssClass="input normal" ReadOnly ="true" sucmsg=" "></asp:TextBox></dd>
  </dl> 
  ...
  <dl>
    <dt>邮箱</dt>
    <dd><asp:TextBox ID="txtEmail" runat="server"  ReadOnly ="true" CssClass="input normal"></asp:TextBox></dd>
  </dl>
</div>
<!--/内容-->
