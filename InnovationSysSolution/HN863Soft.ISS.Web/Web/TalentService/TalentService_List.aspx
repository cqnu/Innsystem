<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TalentService_List.aspx.cs" Inherits="HN863Soft.ISS.Web.Web.TalentService.TalentService_List" %>
                    ...
                    <div class="listFilterItemWrap">
                        <div class="listFilterItemBox clearfix">
                            ...
                            <div class="listFilterItemABox siteIlB_box">
                                ...
                                <asp:LinkButton ID="Recruit" runat="server" CssClass="btn_ALink siteIlB_item" OnClick="Recruit_Click">招聘信息</asp:LinkButton>
                                <asp:LinkButton ID="Train" runat="server" CssClass="btn_ALink siteIlB_item" OnClick="Train_Click">培训班信息</asp:LinkButton>
                ...
                <asp:DataList ID="DataList1" runat="server" RepeatDirection="Horizontal" RepeatColumns="3">
                    ...
                    <ItemTemplate>
                        <div class="pt-list">
                            <dl>
                                <dd>
                                    <a target="_blank" href='TalentService_Show.aspx?id=<%#Eval("id") %>'>
