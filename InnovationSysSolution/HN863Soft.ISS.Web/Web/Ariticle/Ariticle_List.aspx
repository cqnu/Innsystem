<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ariticle_List.aspx.cs" Inherits="HN863Soft.ISS.Web.Web.Ariticle.Ariticle_List" %>
...
<head id="Head1" runat="server">
    ...
    <%--    <script type="text/javascript" src="../skin_v2/js/global.js"></script>--%>
</head>
<body>
                    ...
                    <div class="listFilterItemWrap">
                        <div class="listFilterItemBox clearfix">
                            ...
                            <div class="listFilterItemABox siteIlB_box">
                                ...
                                <asp:LinkButton ID="Appearance" runat="server" CssClass="btn_ALink siteIlB_item" OnClick="Appearance_Click">外观设计</asp:LinkButton>
                                <asp:LinkButton ID="Sample" runat="server" CssClass="btn_ALink siteIlB_item" OnClick="Sample_Click">样品设计</asp:LinkButton>
                                <asp:LinkButton ID="Complete" runat="server" CssClass="btn_ALink siteIlB_item" OnClick="Complete_Click">成套解决方案</asp:LinkButton>
                                <asp:LinkButton ID="Train" runat="server" CssClass="btn_ALink siteIlB_item" OnClick="Train_Click">3D培训</asp:LinkButton>
                            </div>
                        </div>
                        <div class="listFilterItemBox clearfix">
                            <label>排序方式:</label>
                ...
                <asp:DataList ID="DataList1" runat="server" RepeatDirection="Horizontal" RepeatColumns="3">
                    ...
                    <ItemTemplate>
                        <div class="pt-list">
                            <dl>
                                <dd>
                                    <a target="_blank" href='Ariticle_Show.aspx?id=<%#Eval("id") %>'>
