<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ariticle_Show.aspx.cs" Inherits="HN863Soft.ISS.Web.Web.Ariticle.Ariticle_Show" %>
    ...
    <div class="row" style="margin-top: 70px; background: #e8e9ed;">
        ...
        <div class="small-nav niui-w">
            <ul>
                ...
                <%-- <div style="float:right"><input type="button" />举报</div>--%>
