<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PHList.aspx.cs" Inherits="HN863Soft.ISS.Web.Web.PolicyHall.PHList" %>
                            ...
                            <div class="commu-fr">
                                <ul id="list-topic">
                                    <asp:Repeater runat="server" ID="rptList">
                                        <ItemTemplate>
                                            <li>
                                                <h2><a href='PHDetail.aspx?id=<%#Eval("id")%>'><%#Eval("Title") %></a>&nbsp;</h2>
                                                <div class="commu-tap" style="overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical; height: 55px; white-space: normal;">
                                                    <%#Eval("CrawContent") %>
                                                </div>
                                                <div class="commu-tap" style="padding-top: 10px;">管理员 于 <span class="smartTime" smarttime="1480986153"><%#DateTime.Parse(Eval("CrawDate").ToString()).ToString("yyyy.MM.dd hh:mm") %></span> 发表</div>
                                            </li>
                                        </ItemTemplate>
                                        <FooterTemplate>
