<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Fiscal_List.aspx.cs" Inherits="HN863Soft.ISS.Web.Web.Fiscal.Fiscal_List" %>
                ...
                <asp:DataList ID="DataList1" runat="server" RepeatDirection="Horizontal" RepeatColumns="3">
                    ...
                    <ItemTemplate>
                        <div class="pt-list">
                            <dl>
                                <dd>
                                    <a target="_blank" href='Fiscal_Show.aspx?id=<%#Eval("id") %>'>
