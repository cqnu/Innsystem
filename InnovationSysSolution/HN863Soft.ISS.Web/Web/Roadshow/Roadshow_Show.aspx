<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Roadshow_Show.aspx.cs" Inherits="HN863Soft.ISS.Web.Web.Roadshow.Roadshow_Show" %>
...
<head id="Head1" runat="server">
    ...
    <title>查看路演信息</title>
    <link href="../CSS/Show/a25a1f64519e64482c550a31805c2083.css" rel="stylesheet" />
    <link href="../CSS/Show/075164029c450604c632bc43bf813389.css" rel="stylesheet" />
    <link href="../CSS/Show/d041d9b77b9b2e7f292b6493d290ddb3.css" rel="stylesheet" />
    <link href="../CSS/Show/jiathis_share.css" rel="stylesheet" />
    <link href="../CSS/Show/share_style0_16.css" rel="stylesheet" />
...
<body>
        ...
        <div class="header">
            <div style="width: 1080px; margin: 0 auto;">
                ...
                <ul class="menu" style="float: left;">
                    ...
                    <li><a href="#" class="selected">投融资服务</a>
                        <ul class="submenu">
        ...
        <div class="jlxqOuterBox" id="jlxqOuterBox">
            <div class="mainIn02Box">
                <div class="jlxqBox">
                    <!-- 详情header begin -->
                    <div class="jlxqTitle">
                        <div class="jlxqtittext" id="jlxqtittext">
                            <div class="jlxqh3_wai">
                                <h3 class="jlxqTitle_h3" style="width: 100%; overflow: hidden" id="move"><%=model.Title %> </h3>
                            </div>
                            <div class="faqipeeson">
                                <span class="txt1">发起人</span>
                                <span class="txt2" style="text-decoration: none !important;"><font>
                               <%=model.RealName %>   </font></span>
                            </div>
                        </div>
                    </div>
                    <div class="xqDetailBox">
                        ...
                        <div class="xqDetailLeft siteImgBox">
                            <img class="lazy1 go" runat="server" id="img1" />
                        </div>
                        <div class="xqDetailRight">
                            <div class="xqDetailDataBox">
                                <div class="xqDetailData">
                                    <p><span class="ftP">路演</span></p>
                                    <!-- <p class="scP">已筹款</p> -->
                                </div>
                                <br />
                                <div class="xqDetailData">
                                    <p>
                                        <span class="scP"><%=model.Objective %> </span>
                                    </p>
                                    <!-- <p class="scP">支持数</p> -->
                                </div>
                            ...
                            <div class="xqRatioOuterBox">
                                ...
                                <div class="xqRatioText clearfix">
                                    <span class="leftSpan">&nbsp;&nbsp;主讲人：<%= model.Speaker %>                                                    </span>
                            ...
                            <div class="xqRatioOuterBox">
                                ...
                                <div class="xqRatioText clearfix">
                                    <span class="leftSpan">&nbsp;&nbsp;开始时间：<%= Convert.ToDateTime(model.StartTime).ToString("yyyy-MM-dd hh:mm ") %>                                                    </span>

                                </div>
                                <div class="xqRatioText clearfix">
                                    <span class="leftSpan">&nbsp;&nbsp;结束时间：<%= Convert.ToDateTime( model.EndTime).ToString("yyyy-MM-dd hh:mm ") %>                </span>
                            ...
                            <div class="xqDetailBtnBox">
                                ...
                                <span style="text-align: left">
                                    <img src="../CSS/Show/dz.png" />
                                    <a class="site_ALink siteIlB_item"><%=strAddress %></a>

                                </span>
                                &nbsp
                                <span class="addr siteIlB_item">
                                    <img src="../CSS/Show/bq.png" />
                                    <a class="site_ALink siteIlB_item"><%=model.KeyWord %> </a>
                                </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="xqInner">
                <div class="xqMainOuterBox clearfix" id="tage">
                    <div style="height: 600px" runat="server" id="divVideo">
    ...
    <script>
        ...
        window.onload = function () {
            ...
            var divWidth = $("#jlxqtittext").width();//div的宽度
