<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Roadshow_List.aspx.cs" Inherits="HN863Soft.ISS.Web.Web.Roadshow.Roadshow_List" %>
                ...
                <asp:DataList ID="DataList1" runat="server" RepeatDirection="Horizontal" RepeatColumns="4">
                    ...
                    <ItemTemplate>
                        <div class="ssCardItem" style="background: #fff">
                            <a target="_blank" href='Roadshow_Show.aspx?id=<%#Eval("id") %>' style="height: 183px" class="siteCardItemImgA">
                                <img src='<%#Eval("Cover")%>' />
                            </a>
                            <div class="ssCardICBox siteCardICBox">
                                <div class="ssCardICText">
                                    <%-- <h3>--%>
                                    <a class="siteCardICH3" target="_blank" href='Roadshow_Show.aspx?id=<%#Eval("id") %>'><%#Eval("Title").ToString().Length>31?Eval("Title").ToString().Substring(0,31)+"...":Eval("Title")%> </a>
                                    <%--</h3>--%>
