(function () {
  ...
  var createHtml = function (type, msg) {
    ...
    if (type == "alert") {
		    	 _html += '<div id="mb_box" style="width:100%;height:100%;z-index:1111111111110;position:fixed;filter:alpha(opacity=5);opacity:0.05;background:black;top:0;left:0;"></div><div id="mb_con" style="z-index:1111111111111;position:fixed;background:#8bc;border-radius:3px;padding:20px 0;font-size:16px;">';
		    
			 
			_html += '<div id="mb_msg" style="text-align:center;padding:0 20px;color:#fff">' + msg + '</div><div id="mb_btnbox" style="text-align:center;">';
