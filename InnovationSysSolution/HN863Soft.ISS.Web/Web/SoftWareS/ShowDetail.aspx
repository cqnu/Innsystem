<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowDetail.aspx.cs" Inherits="HN863Soft.ISS.Web.Web.SoftWareS.ShowDetail" %>
...
<body style="background-color: #E8E9ED;">
    <div class="header">
        <div style="width: 1080px; margin: 0 auto;">
            ...
            <ul class="menu" style="float: left;">
                ...
                <li><a href="#" class="selected">专业技术服务</a>
                    <ul class="submenu">
    ...
    <div class="row" style="margin-top: 70px; height: 305px; background: #e8e9ed;">
        <div class="user-info niui-w" style="height: auto; overflow: hidden; word-wrap: break-word;">
            <dl>
                <dd>
                ...
                <dt style="width: 80%">
                    ...
                    <div id="jlxqtittext" style="width: 100%">
                        ...
                        <h3 runat="server" style="overflow: hidden; width: 500px; float: left; margin-top: 0px; white-space: nowrap" id="move"></h3>
                        <h3 runat="server" style="width: 270px; float: left;white-space:nowrap;" id="hkeys"></h3>
                    ...
                    <br />
                    <p style="word-wrap: break-word; word-break: normal; width: 760px" runat="server" id="pIntroduce" class="user-intro"></p>
    ...
    <div class="row" style="margin-top: 0px; height: auto; background: #e8e9ed;">
        <div class="user-info niui-w" style="height: auto; word-wrap: break-word">
            <ul class="content">
                <li>
                    <ul class="Header">
                        <li><strong>服务介绍</strong></li>
                        <li>
                            <hr />
                        </li>
                    </ul>
                ...
                <li>
                    <div id="txtIntroduction" class="Contents" runat="server">
                    </div>
                </li>
                <li>
                    <ul class="Header">
                        <li><strong>团队介绍</strong></li>
                        <li>
                            <hr />
                        </li>
                    </ul>
                ...
                <li>
                    <div id="txtTeamIntroduction" class="Contents" runat="server">
                    </div>
                </li>
                <li>
                    <ul class="Header">
                        <li><strong>成功案例</strong></li>
                        <li>
                            <hr />
                        </li>
                    </ul>
                ...
                <li>
                    <div id="txtExample" class="Contents" runat="server">
                    </div>
                </li>
                <li>
                    <ul class="Header">
                ...
                <li>
                    <div id="txtPhone" class="Contents" runat="server"></div>
                </li>
                <li class="end"></li>
            </ul>
        </div>
    ...
    <div class="pop-login">
        ...
        <div class="pop-login-co">
            <form runat="server" class="form-login" name="form3" method="post">
