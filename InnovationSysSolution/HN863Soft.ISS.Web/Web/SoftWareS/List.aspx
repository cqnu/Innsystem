<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="HN863Soft.ISS.Web.Web.SoftWareS.List" %>
        ...
        <div class="row niui-content-1">
            <div class="listFilterBox">
                <div class="mainInnerBox">
                    <div class="listFilterItemWrap">
                        ...
                        <div class="listFilterItemBox clearfix" id="divType" runat="server">
                            <label>服务类型</label>
            ...
            <div style="text-align: center" class="mainInnerBox">
                <asp:DataList ID="DataList1" runat="server" RepeatDirection="Horizontal" RepeatColumns="3">
                    ...
                    <ItemTemplate>
                        <div class="pt-list" style="word-wrap: break-word;">
                            <dl>
                                <dd>
                                    <a target="_blank" href='ShowDetail.aspx?id=<%#Eval("Id") %>&TypeName=<%#RequestHelper.GetQueryString("TypeName") %>'>

                                        <img style="width: 90px; height: 90px;" src='<%#Eval("LogImg").ToString().Replace("\\","/").Replace("~/","../../")%>' />
                                    </a>
                                </dd>
                                <dt style="width: 50%;">
                                    <a target="_blank" href='ShowDetail.aspx?id=<%#Eval("Id") %>&TypeName=<%#RequestHelper.GetQueryString("TypeName")%>'>
                                        <h3 style="text-align: left"><%#Eval("SName").ToString().Length > 12 ? Eval("SName").ToString().Substring(0, 12) + "..." : Eval("SName").ToString()%> </h3>
            ...
            <div style="text-align: center" class="mainInnerBox">
                <div class="pagelist">
                    <div class="l-btns">
                        <span>显示</span><asp:TextBox ID="txtPageNum" runat="server" CssClass="pagenum" onkeydown="return checkNumber(event);" OnTextChanged="txtPageNum_TextChanged"
