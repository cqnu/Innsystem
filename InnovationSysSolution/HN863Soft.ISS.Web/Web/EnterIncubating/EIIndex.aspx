<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EIIndex.aspx.cs" Inherits="HN863Soft.ISS.Web.Web.EnterIncubating.EIIndex" %>
                ...
                <div class="mainInnerBox">
                    <div class="listFilterItemWrap">
                        <div class="listFilterItemBox clearfix">
                            ...
                            <div class="listFilterItemABox siteIlB_box">
                                <asp:Repeater runat="server" ID="rptTypeList" OnItemCommand="rptTypeList_ItemCommand">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="LinkButton1" CssClass='<%#Eval("value").ToString()=="-1"?"btn_ALink siteIlB_item cur":"btn_ALink siteIlB_item" %>' Text='<%#Eval("text") %>' CommandName="order" CommandArgument='<%#Eval("value").ToString()=="0"?"00": Eval("value").ToString()%>' runat="server" />
                                    </ItemTemplate>
                                </asp:Repeater>
                            </div>
                        </div>
                        ...
                        <div class="listFilterItemBox clearfix">
                            <label>显示方式:</label>
                            <div class="listFilterItemABox siteIlB_box">
                                <asp:LinkButton ID="LkForm" runat="server" CssClass="cur btn_ALink siteIlB_item" OnClick="LkForm_Click">默认</asp:LinkButton>
                                <asp:LinkButton ID="LkList" runat="server" CssClass="btn_ALink siteIlB_item" OnClick="LkList_Click">列表显示</asp:LinkButton>
                            </div>
                        </div>
                ...
                <asp:DataList ID="DataList1" runat="server" RepeatDirection="Horizontal" RepeatColumns="3">
                    ...
                    <ItemTemplate>
                        <div class="pt-list">
                            <dl>
                                <dd>
                                    <a target="_blank" href='EIDetail.aspx?id=<%#Eval("id") %>'>

                                        <img style="width: 90px; height: 90px;" src='<%#Eval("LogImg")%>' />
                                    </a>
                                </dd>
                                <dt>
                                    <a target="_blank" href='EIDetail.aspx?id=<%#Eval("id") %>'>
                                        <h3 style="text-align: left"><%#Eval("OrgName").ToString().Length>12?Eval("OrgName").ToString().Substring(0,12)+"...":Eval("OrgName").ToString() %> </h3>
                            ...
                            <%--                            <div class="pt-intro" style="text-align: left"><%#  Eval("Introduce").ToString().Length>15?Eval("Introduce").ToString().Substring(0,15)+"...":Eval("Introduce").ToString() %> </div>--%>
                            <div class="pt-intro" style="text-align: left"><%#  Eval("Introduce").ToString() %> </div>
                            <div class="siteIlB_box" style="text-align: right">

                                <a class="site_ALink siteIlB_item">
                                    <img src="../CSS/dizhi.png" />
                                    <%#Eval("Name") %> &nbsp
                                </a>
                            </div>
                ...
                <asp:Repeater ID="rptList" runat="server" Visible="false">
                    <HeaderTemplate>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
                            <tr>
                                <th style="text-align: center; width: 40%">孵化器公司</th>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td align="center"><%# Eval("OrgName").ToString().Length>20?Eval("OrgName").ToString().Substring(0,20)+"...":Eval("OrgName").ToString() %></td>
                            <td><%# Eval("Introduce").ToString().Length>30?Eval("Introduce").ToString().Substring(0,30)+"...":Eval("Introduce").ToString() %></td>
                            <td><%#Eval("Name")%></td>

                            <td align="center"> <a target="_blank" href='EIDetail.aspx?id=<%#Eval("id") %>'>查看 </td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
