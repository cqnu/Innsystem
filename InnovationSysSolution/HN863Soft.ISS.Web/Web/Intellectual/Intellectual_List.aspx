<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Intellectual_List.aspx.cs" Inherits="HN863Soft.ISS.Web.Web.Intellectual.Intellectual_List" %>
                ...
                <asp:DataList ID="DataList1" runat="server" RepeatDirection="Horizontal" RepeatColumns="3">
                    ...
                    <ItemTemplate>
                        <div class="pt-list">
                            <dl>
                                <dd>
                                    <a target="_blank" href='Intellectual_Show.aspx?id=<%#Eval("id") %>'>
