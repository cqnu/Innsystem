<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Intellectual_Show.aspx.cs" Inherits="HN863Soft.ISS.Web.Web.Intellectual.Intellectual_Show" %>
...
<body>
    ...
    <div class="row" style="margin-top: 70px; background: #e8e9ed;">
        <div class="user-info niui-w" style="min-width: 1042px">
            <dl>
                <dd>
