...
{
    public partial class Intellectual_List : System.Web.UI.Page
    {
        ...
        public void BindData()
        {
            ...
            string pageUrl = Utils.CombUrlTxt("Intellectual_List.aspx", "keywords={0}&sort={1}&page={2}", this.keywords, sort, "__id__");
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("Intellectual_List.aspx", "keywords={0}&sort={1}", txtKeywords.Text, "0"));
        }

        protected void Reverse_Click(object sender, EventArgs e)
        {
            Response.Redirect(Utils.CombUrlTxt("Intellectual_List.aspx", "keywords={0}&sort={1}", txtKeywords.Text, "1"));
        }

        protected void btnSearch_Click(object sender, EventArgs e)
        {

            Response.Redirect(Utils.CombUrlTxt("Intellectual_List.aspx", "keywords={0}&sort={1}", txtKeywords.Text, sort));
        }
