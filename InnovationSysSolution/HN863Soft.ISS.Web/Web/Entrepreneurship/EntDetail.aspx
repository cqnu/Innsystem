<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="EntDetail.aspx.cs" Inherits="HN863Soft.ISS.Web.Web.Entrepreneurship.EntDetail" %>
...
<body>
    <form id="form1" runat="server">
           <!--导航栏-->
        <div class="location">
            <a href="EntShow.aspx" class="back"><i></i><span>返回列表页</span></a>
            <a href="../Center.aspx" class="home"><i></i><span>首页</span></a>
            <i class="arrow"></i>
            <a href="EntShow.aspx"><span>辅导信息列表</span></a>
            <i class="arrow"></i>
            <span>编辑辅导信息</span>
        </div>
   ...
   <%--     <h3>服务范围</h3>
        ...
        <hr />
        <br />
        <asp:DataList runat="server" ID="dlReplyInfo" RepeatColumns="1" DataKeyField="Id" CellSpacing="10" Width="100%">
            <ItemTemplate>
                        ...
                        <td rowspan="3" style="width: 200px">
                            <div style="width: 100%; height: 100%">
                                <ul style="list-style-type: none; padding-left: 0px; margin-left: 5px; margin-top: 5px">
                                    ...
                                    <li>用户名：<%#Eval("UserName") %></li>
                                </ul>
                            </div>
                        </td>
                        <td style="height: 20px">
                            <div style="position: relative">
                                回复于：<%# Eval("Time")%><div style="position: absolute; right: 10px; top: 1px">
                                    #<%#Eval("Floor") %></div>
                            </div>
                        </td>
                    </tr>
