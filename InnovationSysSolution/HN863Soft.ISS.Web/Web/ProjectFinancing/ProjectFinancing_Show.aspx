<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectFinancing_Show.aspx.cs" Inherits="HN863Soft.ISS.Web.Web.ProjectFinancing.ProjectFinancing_Show1" %>
                        ...
                        <div class="xqDetailRight">
                            <div class="xqDetailDataBox">
                                <div class="xqDetailData">
                                    <p><span class="ftP"><%=strType %> </span></p>
                                    <!-- <p class="scP">已筹款</p> -->
                                </div>
                                <br />
                                <div class="xqDetailData">
                            ...
                            <div class="xqRatioOuterBox">
                                <div class="xqRatioText clearfix">
                                    <span class="leftSpan">&nbsp;&nbsp;开始时间：<%= Convert.ToDateTime(model.StartTime).ToString("yyyy-MM-dd") %>                                                    </span>
                                </div>
                                <div class="xqRatioText clearfix">
                                    <span class="leftSpan">&nbsp;&nbsp;结束时间：<%= Convert.ToDateTime( model.EndTime).ToString("yyyy-MM-dd") %>                </span>
                                </div>
                            </div>
