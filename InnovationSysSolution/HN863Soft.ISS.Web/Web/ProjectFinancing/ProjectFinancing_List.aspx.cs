...
{
    public partial class ProjectFinancing_Show : System.Web.UI.Page
    {
        ...
        public void BindData()
        {
            ...
            if (type == "1")
            {
                ...
                Crowd.CssClass = "btn_ALink siteIlB_item cur";

                Whole.CssClass = "btn_ALink siteIlB_item";
                Stock.CssClass = "btn_ALink siteIlB_item";
                Cooperation.CssClass = "btn_ALink siteIlB_item";
            }
            ...
            if (type == "2")
            {
                ...
                Stock.CssClass = "btn_ALink siteIlB_item cur";

                Whole.CssClass = "btn_ALink siteIlB_item";
                Crowd.CssClass = "btn_ALink siteIlB_item";
                Cooperation.CssClass = "btn_ALink siteIlB_item";
            }
            ...
            if (type == "3")
            {
                ...
                Cooperation.CssClass = "btn_ALink siteIlB_item cur";
            ...
            string pageUrl = Utils.CombUrlTxt("ProjectFinancing_List.aspx", "type={0}&keywords={1}&sort={2}&page={3}", type, this.keywords, sort, "__id__");
            PageContent.InnerHtml = Utils.OutPageList(this.pageSize, this.page, this.totalCount, pageUrl, 8);
        }

        protected void btnSearch_Click(object sender, EventArgs e)
        {
            Response.Redirect(Utils.CombUrlTxt("ProjectFinancing_List.aspx", "type={0}&keywords={1}&sort={2}", type, txtKeywords.Text, sort));
        }
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("ProjectFinancing_List.aspx", "type={0}&keywords={1}&sort={2}", "1", txtKeywords.Text, sort));
        }

        protected void Stock_Click(object sender, EventArgs e)
        {
            Response.Redirect(Utils.CombUrlTxt("ProjectFinancing_List.aspx", "type={0}&keywords={1}&sort={2}", "2", txtKeywords.Text, sort));
        }

        protected void Cooperation_Click(object sender, EventArgs e)
        {
            Response.Redirect(Utils.CombUrlTxt("ProjectFinancing_List.aspx", "type={0}&keywords={1}&sort={2}", "3", txtKeywords.Text, sort));
        }

        protected void Whole_Click(object sender, EventArgs e)
        {
            Response.Redirect(Utils.CombUrlTxt("ProjectFinancing_List.aspx", "type={0}&keywords={1}&sort={2}", "", txtKeywords.Text, sort));
        }

        protected void Default_Click(object sender, EventArgs e)
        {
            Response.Redirect(Utils.CombUrlTxt("ProjectFinancing_List.aspx", "type={0}&keywords={1}&sort={2}", type, txtKeywords.Text, "0"));
        }

        protected void Reverse_Click(object sender, EventArgs e)
        {
            Response.Redirect(Utils.CombUrlTxt("ProjectFinancing_List.aspx", "type={0}&keywords={1}&sort={2}", type, txtKeywords.Text, "1"));
        }
