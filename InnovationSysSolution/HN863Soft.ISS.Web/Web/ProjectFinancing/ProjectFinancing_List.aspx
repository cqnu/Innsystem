<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectFinancing_List.aspx.cs" Inherits="HN863Soft.ISS.Web.Web.ProjectFinancing.ProjectFinancing_Show" %>
        ...
        <div class="row niui-content-1">
                    ...
                    <div class="listFilterItemWrap">
                        <div class="listFilterItemBox clearfix">
                            ...
                            <div class="listFilterItemABox siteIlB_box">
                                <asp:LinkButton ID="Whole" runat="server" CssClass="btn_ALink siteIlB_item cur" OnClick="Whole_Click">全部</asp:LinkButton>
                                <asp:LinkButton ID="Crowd" runat="server" CssClass="btn_ALink siteIlB_item" OnClick="Crowd_Click">众筹项目</asp:LinkButton>
                                <asp:LinkButton ID="Stock" runat="server" CssClass="btn_ALink siteIlB_item" OnClick="Stock_Click">股权融资项目</asp:LinkButton>
                                <asp:LinkButton ID="Cooperation" runat="server" CssClass="btn_ALink siteIlB_item" OnClick="Cooperation_Click">股权融资项目</asp:LinkButton>
                            </div>
                        </div>
                        <div class="listFilterItemBox clearfix">
                            <label>排序方式:</label>
            ...
            <div style="text-align: center" class="mainInnerBox">
                <asp:DataList ID="DataList1" runat="server" RepeatDirection="Horizontal" RepeatColumns="4">
                    ...
                    <ItemTemplate>
                        <div class="ssCardItem" style="background: #fff">
                            <a target="_blank" href='ProjectFinancing_Show.aspx?id=<%#Eval("id") %>' style="height: 183px" class="siteCardItemImgA">
                                <img src='<%#Eval("Cover")%>' />
                            </a>
                            <div class="ssCardICBox siteCardICBox">
                                <div class="ssCardICText">
                                    <%-- <h3>--%>
                                    <a class="siteCardICH3" target="_blank" href='ProjectFinancing_Show.aspx?id=<%#Eval("id") %>'><%#Eval("Title").ToString().Length>31?Eval("Title").ToString().Substring(0,31)+"...":Eval("Title")%> </a>
                                    <%--</h3>--%>
                                    <p class="siteCardIC_p souSuo"><%#Eval("Objective") %></p>
                                </div>



                                <div class="siteCardFBox">
                                    <div class="siteCardFLabelBox siteIlB_box" style="text-align: left">
                                        <a class="site_ALink siteIlB_item" style="text-align: right">
                                            <img src="../CSS/gjc.png" />
                                            <%#Eval("KeyWord") %>
                                        </a>
                                    </div>
