<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="ServiceDetail.aspx.cs" Inherits="HN863Soft.ISS.Web.Service.ServiceMange.ServiceDetail" %>
...
<body>
    <form id="form1" runat="server">
        <div class="Info">
            ...
            <label>作者：<%=serviceModel.PublisherId %></label>
            <label>发布时间：<%=Convert.ToDateTime(serviceModel.CreatTime).ToString("yyyy/MM/dd") %></label>
            <hr />
        </div>
        <%-- <div>
            <%= serviceModel.Title %>
        ...
        <div style="width: 100%; position: relative;">
            ...
            <div style="float: left; width: 9%; position: absolute; right: 0px">
                ...
                <asp:Button Text="发表" runat="server" ID="btnReply" OnClick="btnReply_Click" />
            </div>
        </div>
    </form>
</body>
